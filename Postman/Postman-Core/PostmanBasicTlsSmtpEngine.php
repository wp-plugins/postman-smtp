<?php
if (! class_exists ( "PostmanBasicTlsSmtpEngine" )) {
	 ...
	 *        
	 */
	class PostmanBasicTlsSmtpEngine extends PostmanAbstractSmtpEngine implements PostmanSmtpEngine {
		private $username;
		private $password;
		...
		public function createConfig(PostmanEmailAddress $sender, $hostname, $port) {
			...
			$config = array (
					PostmanSmtpEngine::ZEND_TRANSPORT_CONFIG_SSL => PostmanSmtpEngine::ZEND_TRANSPORT_CONFIG_TLS,
