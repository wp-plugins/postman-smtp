...
class YouTubeTest extends BaseTest
{
  ...
  {
    parent::__construct();
    $this->youtube = new Postman_Google_Service_YouTube($this->getClient());
  }
  ...
  public function testMissingFieldsAreNull()
  {
    ...
    $newChannel = new Postman_Google_Service_YouTube_Channel();
    ...
    $owner_details = new Postman_Google_Service_YouTube_ChannelContentOwnerDetails();
    $owner_details->setTimeLinked("123456789");
    $o_channel = new Postman_Google_Service_YouTube_Channel();
    ...
    $ping = new Postman_Google_Service_YouTube_ChannelConversionPing();
    $ping->setContext("hello");
    $pings = new Postman_Google_Service_YouTube_ChannelConversionPings();
