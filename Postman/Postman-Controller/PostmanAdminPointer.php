		...
		function wptuts_register_pointer_testing($p) {
			...
			if (PostmanUtils::isAdmin ()) {
				$p ['postman16_log'] = array (
						...
						'options' => array (
								'content' => sprintf ( '<h3> %s </h3> <p> %s </p>', __ ( 'New for v1.6! Email Log', 'postman-smtp' ), __ ( 'Enable to save a copy of all your emails. Great for troubleshooting or as a backup for messages that get lost. <b>Access the Email Log in the Tools menu.</b>', 'postman-smtp' ) ),
								'position' => array (
										'edge' => 'top',
										'align' => 'left' 
								) 
