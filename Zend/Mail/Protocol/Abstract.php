 ...
 * @see Zend_Validate
 */
require_once WP_PLUGIN_DIR . '/postman/Zend/Validate.php';


/**
 * @see Zend_Validate_Hostname
 */
require_once WP_PLUGIN_DIR . '/postman/Zend/Validate/Hostname.php';
...
abstract class Zend_Mail_Protocol_Abstract
{
    ...
    public function __construct($host = '127.0.0.1', $port = null)
    {
        ...
        if (!$this->_validHost->isValid($host)) {
             ...
             */
            require_once WP_PLUGIN_DIR . '/postman/Zend/Mail/Protocol/Exception.php';
