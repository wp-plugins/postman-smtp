	...
	class PostmanAdminController {
		...
		public function outputDefaultContent() {
			...
			if (PostmanState::getInstance ()->isTimeToReviewPostman ()) {
				...
				printf ( '<p style="margin:0 10px">%s', _n ( 'Postman has delivered %d emails for you!', 'Postman has delivered %d emails for you!', PostmanStats::getInstance ()->getSuccessfulDeliveries (), 'postman-smtp' ) );
